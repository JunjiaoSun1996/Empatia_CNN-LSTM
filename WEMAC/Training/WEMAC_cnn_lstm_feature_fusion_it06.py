...
|_| \_|\___/ \__|   |_|\___/ \__,_|\__,_|\__, |		⠀⠀⣸⣿⣿⣶⣶⣶⣾⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣇
                                         |___/ 		⠀⣤⡟⠛⠋⠉⠙⢿⣿⣿⣿⣿⣿⣿⣿⣿⣿⠟⠉⠈⠋⠈⢿⣿⡿
                                                    ...
                                                    ⠘⢇⠀⠰⣿⣿⢟⢼⣿⣿⣿⣿⣿⣿⣿⣿⡿⢜⠿⠿⠿⠀⡀⠀⠀
@Author: Junjiao Sun                               
@Time : Created in 10:53 PM 2024/02/19   
@FileName: WEMAC_cnn_lstm_feature_fusion_it06.py                           
@Software: PyCharm
...
from utils import progress_bar, set_reconstruct
import cudf
...
def training_process_fusion(net_type, featureMap_stratgy, dimension_type, fusion_num):
    ...
    nowTrain_label = np.array(nowTrain_label)
    nowTest_label = np.array(nowTest_label)
    train_feature_map, test_feature_map, nowTrain_label, nowTest_label = \
        set_reconstruct(train_feature_map, test_feature_map, nowTrain_label, nowTest_label)
